...
export default function Skeleton() {
  return (
    <div classaName="overflow-hidden shadow-lg rounded-lg max-h-96 w-80 cursor-pointer mx-auto">
      <div className="bg-gray-500 rounded-xl h-40 overflow-hidden animate-pulse mb-2"></div>
      <div className="h- p-3">
