...
export default function Footer() {
  return (
    <footer className="max-w-5xl mx-auto p-4 bg-white sm:p-6 dark:bg-zinc-900">
        ...
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
          ...
          <div>
            ...
            <ul className="text-gray-600 dark:text-gray-400">
              <li className="mb-4">
                <a
                  href="https://github.com/amrohan/DevNews-Frontend"
              ...
              <li>
                <a href="https://t.me/DevBudbot" className="hover:underline">
                  Telegram Bot
                </a>
              </li>
            </ul>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
        ...
        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
          <a
            href="https://www.instagram.com/amrohxn/"
          ...
          <a
            href="https://www.facebook.com/amrohxn/"
            className="text-gray-500 hover:text-gray-900 dark:hover:text-white"
          >
            <svg
              className="w-5 h-5"
